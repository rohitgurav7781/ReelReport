    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 mt-6">
      ...
      <div className="flex items-center justify-between mb-8">
         <div className="flex items-center space-x-4">
            ...
            <h2 className="text-2xl font-bold">Register to ReelReport</h2>
          </div>
        ...
        <div>
            ...
            <input
              ...
              onBlur={() => handleUsernameChange({ target: { value: username } })}
          ...
          <div className="flex items-center space-x-4 mb-2">
            ...
            >
              By registering you agree to the <a href='https://corp.reelreport.com/tos/' target='_blanck' className='text-blue-500 cursor-pointer'>Terms and Conditions</a>. Please read them carefully.
            </label>
          </div>
        </form>
      </div>
